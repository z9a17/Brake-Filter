...
- `release\Brake-Filter-v0.3.1.zip`

## Install and set up

1. Download `Brake-Filter-v0.3.1.zip` from the [latest release](https://github.com/z9a17/Brake-Filter/releases/latest). Do not extract it.
